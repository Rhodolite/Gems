...
from    Capital.BuiltIn     import  privileged_2                        #   Capital.Core
    ...
    transport('Capital.Exception',                  'PREPARE_RuntimeError')
    ...
    transport('Capital.Optional',                   'optional')
    ...
    transport('Capital.Portray',                    'portray_python_built_in_function_or_method')
